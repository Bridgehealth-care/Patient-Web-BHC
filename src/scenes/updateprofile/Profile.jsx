...
const Profile = () => {
  ...
  return (
    <div className="mt-[50px] w-full h-auto flex flex-col pl-3 pt-2 font-open_sans">
      <div className="bg-blue-200 shadow-2xl rounded-2xl w-[99%] h-[99%]  pt-9  p-10 flex flex-col">
        ...
        <div className="flex h-32 items-center space-x-8">
          ...
          <div className="flex flex-col space-y-3">
            <span className="font-bold text-2xl  text-baby_blue_links">
              Divyanshi Mehra
            </span>
            <span className="text-green-500 bg-blue-200 rounded-xl w-24 text-md flex items-center justify-center space-x-3">
              <span className="w-2 h-2 bg-green-500 block rounded-2xl animate-pulse"></span>
              <span className="font-bold">Active</span>
            </span>
          </div>
        </div>
        <div className="flex flex-col space-y-3 text-lg p-4 bg-blue-100 rounded-2xl w-4/5 shadow-[0px_0px_12px_-2px_rgba(0,0,0,0.3)] shadow-baby_blue_links pl-9">
          {user_data.map((ele) => (
        ...
        <div className="bg-blue-200 px-4 py-3 mt-3 text-right sm:px-6">
          <button
            type="submit"
